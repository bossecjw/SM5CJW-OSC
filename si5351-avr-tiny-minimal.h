/*
 * si5351-avr-tiny-minimal.h - Minimal Si5351 library for avr-gcc and
...
#ifndef SI5351_TINY_MINIMAL_H_
#define SI5351_TINY_MINIMAL_H_
...
void si5351_set_ms(enum si5351_clock, struct Si5351Frac, uint8_t, uint8_t, uint8_t);
